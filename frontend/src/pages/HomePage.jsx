...
export default function Home() {
  return (
    <main className="pt-16">
      ...
      ">
        {/* Subtle blue glow in the background for depth */}
        <div className="
        ...
        <div className="max-w-6xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-12 items-center">
          ...
          {/* Right: mock application status card */}
              ...
              {[
                ...
                ">
                  <div>
                    ...
                    <p className="text-light-muted dark:text-dark-muted text-xs mt-0.5">
                      Application #2025
                    </p>
                  </div>
      ...
      {/* ─── 4. HOW IT WORKS ─────────────────────────────────────── */}
      <section className="py-24 bg-light-surface dark:bg-dark-surface">
          ...
          <div className="space-y-8">
            {[
              ...
              <div key={item.step} className="flex gap-6 items-start">
                ...
                <div className="pt-2">
                  <h3 className="text-light-text dark:text-dark-text font-semibold text-lg mb-1">
                    {item.title}
                  </h3>
                  <p className="text-light-muted dark:text-dark-muted text-sm leading-relaxed">
                    {item.desc}
